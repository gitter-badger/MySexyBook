var EmailCompleter = function (input, trigger_char, domains) {
	this.input = input;
	...
	this.input.nextSibling ? this.input.parentNode.insertBefore(this.datalist, this.input) : this.input.parentNode.appendChild(this.datalist);
